                        ...
                        <form method="POST" action="/admin/products/store" enctype="multipart/form-data">
                            ...
                            <div class="event">
                                <div class="form-group row">
                                    <label for="img" class="col-2 col-form-label">上傳主要圖片</label>
                                    <div class="col-10">
                            ...
                            <div class="event">
                                <div class="form-group row">
                                    <label for="img" class="col-2 col-form-label">上傳第一張產品圖片</label>
                                    <div class="col-10">
                            ...
                            <div class="event">
                                <div class="form-group row">
                                    <label for="img" class="col-2 col-form-label">上傳第二張產品圖片</label>
                                    <div class="col-10">
                            ...
                            <div class="event">
                                <div class="form-group row">
                                    <label for="img" class="col-2 col-form-label">上傳第三張產品圖片</label>
                                    <div class="col-10">
